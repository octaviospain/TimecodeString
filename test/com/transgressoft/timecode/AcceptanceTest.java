...
public class AcceptanceTest {
    ...
    static void addTestCase(Map<Pair<String, String>, String> casesMap, String frameRate, String argument,
            String output) {
    ...
    /**
     * Creates a {@link TimecodeString} object given the {@link Pair} with the input
     *
     * @param input A {@link Pair} containing the frame rate type and the {@code argument} string
     *
     * @return The <tt>TimecodeString</tt> object
     *
     * @throws TimecodeException
     */
    TimecodeString getTimecodeFromInputPair(Pair<String, String> input) throws TimecodeException {
        String frameRate = input.getKey();
        String argument = input.getValue();
        return TimecodeString.of(frameRate, argument);
    }
    ...
    class Fps25TimecodeAcceptanceTests {
        ...
        Stream<DynamicTest> fps25ValuesTestFactory() {
            ...
            return DynamicTest.stream(fps25CasesIterator,
                                      input -> "Input: " + fps25WithUnitsCases.get(input) + " Expected output: " + input
                                              .getValue(), Unchecked.consumer(this::assertFps25UnitsCase));
        }

        void assertFps25UnitsCase(Pair<String, String> input) throws Exception {
            String expectedOutput = fps25WithUnitsCases.get(input);
            assertEquals(expectedOutput, getTimecodeFromInputPair(input).getFrameCountString());
        }
        ...
        Stream<DynamicTest> fps25WithFrameCountTestFactory() {
            ...
            return DynamicTest.stream(fps25CasesIterator, input -> "Input: " + fps25WithFrameCountCases
                                              .get(input) + " Expected output: " + input.getValue(),
        ...
        void assertFps25FrameCountCase(Pair<String, String> input) throws Exception {
            ...
            assertEquals(expectedOutput, getTimecodeFromInputPair(input).getFullTimecodeString());
        }
    }
    ...
    class Df30TimecodeAcceptanceTests {
        ...
        Stream<DynamicTest> df30ValuesTestFactory() {
            ...
            return DynamicTest.stream(fps25CasesIterator,
                                      input -> "Input: " + df30WithUnitCases.get(input) + " Expected output: " + input
                                              .getValue(), Unchecked.consumer(this::assertDf30UnitsCase));
        }

        void assertDf30UnitsCase(Pair<String, String> input) throws Exception {
        ...
        Stream<DynamicTest> df30WithFrameCountTestFactory() {
            ...
            return DynamicTest.stream(fps25CasesIterator, input -> "Input: " + df30WithFrameCountCases
                                              .get(input) + " Expected output: " + input.getValue(),
